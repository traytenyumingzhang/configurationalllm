...
class HomePage(QWidget):
    ...
    def __init__(self, main_window=None): # Added main_window parameter
    ...
    def enter_page(self):
        ...
        pass # No specific action needed for home page on entry

    def leave_page(self):
        """Called when page is navigated away from."""
        pass # No specific action needed for home page on leave
