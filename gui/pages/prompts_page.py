...
"""
    ...
    def enter_page(self):
        ...
        # Reload prompts from config manager when page is entered
        self.prompts = self.config_manager.get_prompts()
        self.prompt_edit.setText(self.prompts.get("system_prompt", self.default_prompt))
        # Reset editing state
        self.prompt_edit.setReadOnly(True)
        self.save_btn.setEnabled(False)
        self.prompt_edit.setPalette(QPalette()) # Reset to default palette
        self.warning_label.setText("⚠️ This is a beta feature. Click Edit to proceed.")


    def leave_page(self):
        """Called when page is navigated away from."""
        # Optionally, prompt to save if changes are unsaved
        pass
